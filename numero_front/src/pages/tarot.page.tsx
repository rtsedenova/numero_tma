...
// Генерация всех 78 карт (22 Старших + 56 Младших)
const wheelCards: TarotWheelCard[] = [
  ...
  { id: 77, image: "/assets/minor_arcana/king_of_wands.jpg",      alt: "King of Wands" }, // fix: file name
];
