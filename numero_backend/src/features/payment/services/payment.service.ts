...
export class TelegramStarsService {
  ...
  static async createInvoiceLink({
    ...
    try {
      console.log('[PAYMENT] Creating invoice with params:', {
        title,
        description,
        payload,
        currency,
      ...
      console.log('[PAYMENT] Bot is authorized:', botInfo.username);
      ...
      console.error('[PAYMENT] Error creating invoice link:', error);
